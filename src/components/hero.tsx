    ...
    <section id="hero" className="noisy">
        ...
        <div className="body">
            <div className="content ">
                <div className="space-y-4 hidden md:block md:pt-10 ">
                ...
                <div className="view-cocktails">
                    <p className="subtitle">Every cocktail on our menu is a blend of
                         premium ingredients, creative flair, and timeless recipes — 
